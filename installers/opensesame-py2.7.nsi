...
!define PRODUCT_VERSION "3.2.5-py2.7-win32-1"
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\OpenSesame\OpenSesame.lnk" "$INSTDIR\pythonw.exe" "${EXEC_SUBFOLDER}safelaunch-opensesame.py" "$INSTDIR\share\opensesame_resources\opensesame.ico"
  CreateShortCut "$SMPROGRAMS\OpenSesame\OpenSesame (runtime).lnk" "$INSTDIR\pythonw.exe" "${EXEC_SUBFOLDER}safelaunch-opensesamerun.py" "$INSTDIR\share\opensesame_resources\opensesamerun.ico"
