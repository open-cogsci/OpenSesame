...
#
# Created: Sat Sep  8 16:23:33 2012
...
class Ui_opensesame_mainwindow(object):
    def setupUi(self, opensesame_mainwindow):
        ...
        self.dock_overview.setMinimumSize(QtCore.QSize(200, 113))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.itemtree.sizePolicy().hasHeightForWidth())
        self.itemtree.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.edit_stdout.sizePolicy().hasHeightForWidth())
        self.edit_stdout.setSizePolicy(sizePolicy)
