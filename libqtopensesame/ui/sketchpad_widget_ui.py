...
class Ui_sketchpad_widget(object):
    def setupUi(self, sketchpad_widget):
        ...
        sketchpad_widget.resize(1053, 635)
    ...
    def retranslateUi(self, sketchpad_widget):
        ...
        self.edit_color.setToolTip(QtGui.QApplication.translate("sketchpad_widget", "Pen color", None, QtGui.QApplication.UnicodeUTF8))
        self.edit_color.setText(QtGui.QApplication.translate("sketchpad_widget", "white", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_font_family.setText(QtGui.QApplication.translate("sketchpad_widget", "Font family", None, QtGui.QApplication.UnicodeUTF8))
        self.combobox_font_family.setToolTip(QtGui.QApplication.translate("sketchpad_widget", "Font family", None, QtGui.QApplication.UnicodeUTF8))
        self.combobox_font_family.setItemText(0, QtGui.QApplication.translate("sketchpad_widget", "mono", None, QtGui.QApplication.UnicodeUTF8))
        self.combobox_font_family.setItemText(1, QtGui.QApplication.translate("sketchpad_widget", "sans", None, QtGui.QApplication.UnicodeUTF8))
        self.combobox_font_family.setItemText(2, QtGui.QApplication.translate("sketchpad_widget", "serif", None, QtGui.QApplication.UnicodeUTF8))
        self.label_font_size.setText(QtGui.QApplication.translate("sketchpad_widget", "Font size", None, QtGui.QApplication.UnicodeUTF8))
        self.spin_font_size.setToolTip(QtGui.QApplication.translate("sketchpad_widget", "Font size", None, QtGui.QApplication.UnicodeUTF8))
        self.spin_font_size.setSuffix(QtGui.QApplication.translate("sketchpad_widget", "pt", None, QtGui.QApplication.UnicodeUTF8))
