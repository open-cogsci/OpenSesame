...
class text_input(item.item, generic_response.generic_response):
	...
	def __init__(self, name, experiment, string = None):
		...
		self.question = "Enter text and press 'enter' to accept."
		self.linewidth = 600
		self.frame = "yes"
		self.frame_width = 3
...
class qttext_input(text_input, qtplugin.qtplugin):
	...
	def init_edit_widget(self):
		...
		self.add_line_edit_control("question", "Question", tooltip = "The question to be displayed above the input field")
