...
class Ui_preferences_widget(object):
    def setupUi(self, preferences_widget):
        ...
        preferences_widget.resize(702, 1200)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 682, 1180))
        ...
        self.formLayout_4.setWidget(1, QtGui.QFormLayout.FieldRole, self.combobox_style)
        self.label_7 = QtGui.QLabel(self.groupBox_5)
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.formLayout_4.setWidget(2, QtGui.QFormLayout.LabelRole, self.label_7)
        self.combobox_theme = QtGui.QComboBox(self.groupBox_5)
        self.combobox_theme.setObjectName(_fromUtf8("combobox_theme"))
        self.formLayout_4.setWidget(2, QtGui.QFormLayout.FieldRole, self.combobox_theme)
        self.label_8 = QtGui.QLabel(self.groupBox_5)
        self.label_8.setWordWrap(True)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.formLayout_4.setWidget(0, QtGui.QFormLayout.SpanningRole, self.label_8)
        ...
        self.formLayout_4.setWidget(3, QtGui.QFormLayout.SpanningRole, self.checkbox_small_toolbar)
        ...
        self.formLayout_4.setWidget(4, QtGui.QFormLayout.SpanningRole, self.checkbox_toolbar_text)
    ...
    def retranslateUi(self, preferences_widget):
        ...
        self.label_2.setText(QtGui.QApplication.translate("preferences_widget", "Interface style", None, QtGui.QApplication.UnicodeUTF8))
        self.label_7.setText(QtGui.QApplication.translate("preferences_widget", "icon theme", None, QtGui.QApplication.UnicodeUTF8))
        self.label_8.setText(QtGui.QApplication.translate("preferences_widget", "<small><i>Changes take effect the next time you start OpenSesame</i></small>\n"
"", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label.setText(QtGui.QApplication.translate("preferences_widget", "<small><i>If you experience stability issues, you can enable the \'Run experiments in a separate process\' option. This essentially means that \'opensesamerun[.exe]\' is used to run your experiment.</i></small>", None, QtGui.QApplication.UnicodeUTF8))
