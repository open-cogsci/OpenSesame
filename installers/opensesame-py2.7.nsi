...
!define PRODUCT_VERSION "3.2.7-py2.7-win32-1"
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\OpenSesame\OpenSesame (runtime).lnk" "$INSTDIR\python.exe" "${EXEC_SUBFOLDER}safelaunch-opensesamerun.py" "$INSTDIR\share\opensesame_resources\opensesamerun.ico"
